...
- NORMAL: 안전한 일반 발화
- PROFANITY: 단순 욕설·비하 표현(예: "바보", "멍청이")이지만 죽음이나 신체적 해악을 언급하지 않음
- PII: 이름, 전화번호, 주소 등 개인정보가 포함됨
- RISK: 자신이든 남이든 죽음·자해·신체적 해악을 바라거나 가하겠다는 표현
  (예: "죽고 싶어", "죽어버려", "때릴 거야" — 대상이 나 자신인지 상대방인지는 분류에 영향을 주지 않는다. 둘 다 RISK다)
반드시 아래 JSON 형식으로만 답하라. 다른 텍스트를 덧붙이지 마라.
